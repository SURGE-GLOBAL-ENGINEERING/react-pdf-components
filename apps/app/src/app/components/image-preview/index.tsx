import { Image, Page } from '@surge-global-engineering/react-pdf-components';
...
const TextPreview: FC<TextPreviewProps> = () => {
  return (
    <Page style={{ fontSize: 12, fontFamily: 'Open Sans' }} size="A4">
      <Image
        width={25}
        caption="Lorem Ipsum is simply dummy text of the printing and typesetting industry. recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum."
      ...
      <Image
        ...
        alignment="center"
        src="https://media.istockphoto.com/photos/view-of-lighthouse-dondra-matara-sri-lanka-picture-id912181808?k=20&m=912181808&s=612x612&w=0&h=m5D1CtXIk9SjiWL_2MTtEcBbOAQpH7yJhUFyM8d7diE="
      ></Image>
